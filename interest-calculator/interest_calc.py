...
class interest_calculator:
    ...
    def si(self):
        ...
        ttk.Button(window2, text="Back 🔙", command=lambda:[window2.destroy(),self.setup()]).pack(pady=10)
        window2.mainloop()
    ...
    def nc(self):
        ...
        ttk.Button(window3, text="Back 🔙", command=lambda:[window3.destroy(), self.setup()]).pack(pady=10)
    ...
    def cc(self):
        ...
        ttk.Button(window4, text="Back 🔙", command=lambda:[window4.destroy(), self.setup()]).pack(pady=10)
...
setup = interest_calculator().setup()
